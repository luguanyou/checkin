...
export interface ScoreItem { id: string; category: ScoreCategory; name: string; occurred_on: string; description: string }
...
export interface ScoreItemInput { category: ScoreCategory; name: string; occurred_on: string; description: string }
